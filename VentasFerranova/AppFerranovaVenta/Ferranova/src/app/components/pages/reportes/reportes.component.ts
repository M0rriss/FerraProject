...
export class ReportesComponent implements OnInit {
  ...
  generarBoleta() {
    if (this.ngxPrintDirective) {
      this._snackBar.open("Imprimiendo boleta...", 'Procesando', { duration: 2000 });

      this.ngxPrintDirective.print();
    } else {
      this._snackBar.open("Error al acceder a ngxPrintDirective", 'Error', { duration: 2000 });
    }
  }
}
